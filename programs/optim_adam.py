...
if __name__ == "__main__":
    ...
    function_const = 2.
    num_iters = 200
    init_point = [-8., 10**(-8)]  # 初期値

    algorithms = ['SGD', 'NAG', 'RMSprop', 'Adam']
    optimizers = {}
    ...
    for alg in algorithms:
        ...
        optimizers['NAG'] = optim.SGD(params, lr=0.1, momentum=0.9, nesterov=True)
        optimizers['RMSprop'] = optim.RMSprop(params, lr=0.1, alpha=0.99) # default 0.99
        optimizers['Adam'] = optim.Adam(params, lr=0.1) # default 0.99
    ...
    # 画像
    colors_dict = {'SGD' : 'r', 'Momentum': 'orange', 'Adagrad': 'b', 'RMSprop': 'g' , 'Adam': 'k', 'NAG': 'm'}
    fig = plt.figure(figsize=(8, 6))
    ax = fig.add_subplot(1, 1, 1, projection='3d')
    xlim, ylim = [-10, 10], [-10, 10]
    zlim = [func(0, ylim[0], const=function_const), func(xlim[1], 0, const=function_const)]
    ...
    anim = FuncAnimation(fig, update, frames=theta, interval=150)
    save_path = "../figures/adam.gif"
